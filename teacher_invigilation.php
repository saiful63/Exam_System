...
<body class="bg-light">
    ...
    ?>
    <h1  class="b_hf">Give specific information to see teacher invigilation.</h1>
    ...
    <div class="row bg-white b_containr">
      ...
      <div class="col-md-8">  
        <form class="b_h" action="see_teacherinv.php"method="post">
         <div class="input-group">
          ...
          <button type="submit" class="btn btn-primary mt-2" name="sub">See invigilation</button>
